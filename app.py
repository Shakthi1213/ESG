...
.rec-high   { background: #fff3f3; border: 1px solid #ef9a9a; }
.rec-medium { background: #fffde7; border: 1px solid #ffe082; }
.rec-low    { background: #f1f8e9; border: 1px solid #a5d6a7; }
